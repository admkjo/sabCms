...
//import com.sabonay.commons.CMSDataSource;
//import java.io.File;
...
// * @author emma
// */
//public class CommonQueryCRUD1 {
//
//    ELContext elContext = FacesContext.getCurrentInstance().getELContext();
//    private final CommonQuery commonquery;
//
//    public CommonQueryCRUD1() {
...
//
//    public static void processCRUD(HttpServletRequest request) throws SQLException {
////        try {
////            ppRequest = new HashMap<>();
////            List<FileItem> items = new ServletFileUpload(new DiskFileItemFactory()).parseRequest(request);
////            items.stream().forEach((FileItem item) -> {
////                if (item.isFormField()) {
