...
// Include Style Sheet
document.write('<link rel="stylesheet" type="text/css" href="../admin/' +cssDir+ 'styles.css">\n');
...
function generate_wysiwyg(textareaID) {
  ...
  var toolbar;
  toolbar =  '<table cellpadding="0" cellspacing="0" border="0" class="toolbar1" style="width:' + toolbarWidth + 'px;"><tr><td style="width: 6px;"><img src="../admin/' +imagesDir+ 'seperator2.gif" alt="" hspace="3"></td>';
  ...
  var toolbar2;
  toolbar2 = '<table cellpadding="0" cellspacing="0" border="0" class="toolbar2" style="width:' + toolbarWidth + 'px;"><tr><td style="width: 6px;"><img src="../admin/' +imagesDir+ 'seperator2.gif" alt="" hspace="3"></td>';
...
function outputFontSelect(n) {
  ...
  var FontSelectOn         = FontSelectObj[3];
	...
	FontSelectDropDown[n] = '<table border="0" cellpadding="0" cellspacing="0"><tr><td onMouseOver="document.getElementById(\'selectFont' + n + '\').src=\'' + FontSelectOn + '\';" onMouseOut="document.getElementById(\'selectFont' + n + '\').src=\'' + FontSelect + '\';"><img src="../admin/' + FontSelect + '" id="selectFont' + n + '" width="85" height="20" onClick="showFonts(\'' + n + '\');" unselectable="on"><br>';
...
function outputFontSizes(n) {
  ...
  var FontSizeOn         = FontSizeObj[3];
	...
	FontSizesDropDown[n] = '<table border="0" cellpadding="0" cellspacing="0"><tr><td onMouseOver="document.getElementById(\'selectSize' + n + '\').src=\'' + FontSizeOn + '\';" onMouseOut="document.getElementById(\'selectSize' + n + '\').src=\'' + FontSize + '\';"><img src="../admin/' + FontSize + '" id="selectSize' + n + '" width="49" height="20" onClick="showFontSizes(\'' + n + '\');" unselectable="on"><br>';
